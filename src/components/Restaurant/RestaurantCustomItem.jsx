        ...
        <div className="relative border rounded-md border-gray-200" >
            ...
            <div onClick={previewButton}>
                <div className='relative h-32'>
                    <ImageWithFallback className="rounded-t-md w-full object-cover h-full" src={image} alt='' draggable="false" />
                ...
                <div className="p-1 py-2 flex justify-between items-center">
                    <div className='flex gap-1 items-center'>
                        <ImageWithFallback className="border border-borderGray w-8 h-8 rounded-full" src={logo} alt='' draggable="false" />
